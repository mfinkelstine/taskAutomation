				...
				buttons : {
					"Submit" : function() {
						...
						if ( tskval === "0" ) { //single }'
							...
							var formResults  = "type=addTask&addTask_Storage="+storageID+"&addTask_Backend="+backendID+"&addTask_clients="+clientsIDs+"&addTask_TestType="+testTypeID+"2&addTask_users="+userID;
